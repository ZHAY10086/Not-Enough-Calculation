...
public class FlowInputNode extends FlowItemNode {
    public FlowInputNode(Ingredients ingredient, int x, int y) {
        super(ingredient, x, y);
    }

    @Override
	public void draw(GuiFlowChart gui) {
		gui.drawItemSlot((int) this.canvasX, (int) this.canvasY, 1);
